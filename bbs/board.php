...
if($board['bo_table'] == 'community_notice'){?>
    <div class="lnb">
        <h2 class="s_visual5">커뮤니티</h2>
        <ul class="sub_2dmenu">
            <li>
                <a href="/bbs/board.php?bo_table=community_notice" class=" on" target="_self" title="공지사항">
                    <span>공지사항</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="/bbs/board.php?bo_table=referenceRoom" class="" target="_self" title="자료실">
                    <span>자료실</span>
                </a>
            </li>
        </ul>
...
else if($board['bo_table'] == 'dept_news'){?>
    <div class="lnb">
        <h2 class="s_visual5">커뮤니티</h2>
        <ul class="sub_2dmenu">
            <li>
            ...
            <li>
                <a href="/bbs/board.php?bo_table=dept_news" class="on" target="_self" title="학과소식">
                    <span>학과소식</span>
                </a>
            </li>
            <li>
...
else if($board['bo_table'] == 'referenceRoom'){?>
    <div class="lnb">
        <h2 class="s_visual5">커뮤니티</h2>
        <ul class="sub_2dmenu">
            <li>
            ...
            <li>
                <a href="/bbs/board.php?bo_table=referenceRoom" class="on" target="_self" title="자료실">
                    <span>자료실</span>
                </a>
            </li>
        </ul>
...
else if($board['bo_table'] == 'employment_info'){?>
    <div class="lnb">
        ...
        <ul class="sub_2dmenu">
            ...
            <li>
                <a href="/bbs/board.php?bo_table=employment_info" class="on" target="_self" title="취업안내">
                    <span>취업안내</span>
                </a>
            </li>
        </ul>
...
else if($board['bo_table'] == 'admission_cons'){?>
    <div class="lnb">
        ...
        <ul class="sub_2dmenu">
            ...
            <li>
                <a href="/bbs/board.php?bo_table=admission_cons" class="on" target="_self" title="입학상담">
                    <span>입학상담</span>
                </a>
            </li>
        </ul>
